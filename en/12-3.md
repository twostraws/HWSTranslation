...
The initializer is used when loading objects of this class, and `encode()` is used when saving. The code is very similar to using `UserDefaults`, but I'm typecasting both values using `as!` because I saved the data so I know what I'm loading.
