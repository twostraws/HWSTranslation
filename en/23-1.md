...
Remarkably, we're going to make this project in just over 100 lines of code. To begin, create a new SpriteKit project in Xcode named Project23. Configure it to work only on landscape iPads, then download the files for this project and copy the Content folder into your project.
